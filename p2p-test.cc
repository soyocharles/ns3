...
main (int argc, char *argv[])
{
  ...
  tapBridge.SetAttribute ("Mode", StringValue ("ConfigLocal"));
  tapBridge.SetAttribute ("DeviceName", StringValue ("ctrl1"));
  ...
  // ghost node.
  //
  tapBridge.SetAttribute ("DeviceName", StringValue ("ctrl2"));
  tapBridge.Install (nodes.Get (1), devices.Get (1));
  csma.EnablePcapAll("taplink");
  //
